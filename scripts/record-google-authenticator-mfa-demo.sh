...
OUTPUT_PATH="$OUTPUT_DIR/mob-google-authenticator-mfa-demo.mp4"
TMP_MOV="/tmp/fixyz-mob-google-authenticator-mfa-demo.mov"
...
METRO_LOG="/tmp/fixyz-mob-mfa-demo-metro.log"
SERVER_LOG="/tmp/fixyz-mob-mfa-demo-auth-server.log"
RECORDER_LOG="/tmp/fixyz-mob-mfa-demo-record.log"
FFMPEG_LOG="/tmp/fixyz-mob-mfa-demo-ffmpeg.log"
FLOW_PATH="$ROOT_DIR/e2e/maestro/auth-film/07-register-abandon-relogin-enroll.yaml"
...
xcrun simctl io booted recordVideo --force --codec=h264 "$TMP_MOV" >"$RECORDER_LOG" 2>&1 &
recorder_pid="$!"
sleep 1
